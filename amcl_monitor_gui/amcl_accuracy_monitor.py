...
class AMCLMonitorWindow(QMainWindow):
    ...
    def __init__(self, ros_worker):
        ...
        # X方向の精度
        self.x_bar = AccuracyBar("X方向", 0.5, 0.1, 0.3, "m")
        accuracy_layout.addWidget(self.x_bar)
        
        # Y方向の精度
        self.y_bar = AccuracyBar("Y方向", 0.5, 0.1, 0.3, "m")
        accuracy_layout.addWidget(self.y_bar)
        
        # Yaw方向の精度
        self.yaw_bar = AccuracyBar("Yaw角", 30.0, 5.7, 17.0, "°")
        ...
        self.connection_timer.start(1000)  # 1秒ごと
    ...
    def update_display(self, data):
        ...
        # 精度バーを更新
        self.x_bar.update_value(data['std_x'])
        self.y_bar.update_value(data['std_y'])
        self.yaw_bar.update_value(data['std_yaw'])
